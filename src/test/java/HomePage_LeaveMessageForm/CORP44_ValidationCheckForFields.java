...
public class CORP44_ValidationCheckForFields {
    ...
    @AfterTest
    public void checkCase44Result() {
        Boolean case44Res = true;
        ...
        if (case44Res) {
            RecordTestRunResult.passedTestRunRecord("44");
        } else {
            RecordTestRunResult.failedTestRunRecord("44");
        }
    }
}
