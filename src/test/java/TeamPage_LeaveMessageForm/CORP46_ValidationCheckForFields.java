...
public class CORP46_ValidationCheckForFields {
    ...
    @AfterTest
    public void checkCase46Result() {
        Boolean case46Res = true;
        ...
        if (case46Res) {
            RecordTestRunResult.passedTestRunRecord("46");
        } else {
            RecordTestRunResult.failedTestRunRecord("46");
        }
    }
}
